...
(function (global, factory) {
  ...
  function detectWebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      // this code into the iframeThere are some compile time errors that might occur there.
      // For example, using single line (double-slash) comments like this one inside that function
      // will probably cause it to chokeChrome will show an error like this:
  ...
  function conflictDetection() {
    ...
    if (testCount === 0) {
      ...
      pollUntil({
        ...
        if (e === 'timeout') {
          console.info('TIME OUT! We waited until we got tiredHere\'s what we found:');
          setDoneResults({
            nodesTested: nodesTested,
            nodesFound: nodesFound
          });
